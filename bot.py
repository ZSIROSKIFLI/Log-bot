...
@bot.tree.command(name="toprpg", description="Ki játszotta legtöbbet a DRX RPT-t?")
@app_commands.describe(game="Játék neve (alapértelmezett: DRX RPT)")
async def toprpg(interaction: discord.Interaction, game: str = "DRX RPT"):
    results = []
